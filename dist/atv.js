...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pubsubJs = __webpack_require__(329);

	var _pubsubJs2 = _interopRequireDefault(_pubsubJs);

	var _lzString = __webpack_require__(330);

	var _lzString2 = _interopRequireDefault(_lzString);

	var _parser = __webpack_require__(331);
	...
	var _handler = __webpack_require__(334);
	        ...
	        onMenuItemSelect: function onMenuItemSelect(e) {
	            ...
	            if (elementType === 'menuitem') {
	                ...
	                if (!element.pageDoc && page) {
	                    ...
	                    // load the page
	                    page(options).then(function (doc) {
